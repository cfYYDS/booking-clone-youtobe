    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        >
          <Link href='/' className="-m-1.5 p-1.5">
            ...
            <img src="/next.svg" className="h-12 w-auto" alt="" />
          </Link>
        </div>
      ...
      <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
            {callsToAction.map((item)=>(
              ...
              flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-[#013b94] hover:bg-gray-100">
                    ...
                    <Disclosure as="div" className="-mx-3">
                      {
                        ({open})=>(
                          ...
                          flex w-full items-center justify-between rounded-lg px-3 py-2 text-base font-semibold
                          ...
                          <Disclosure.Panel className="mt-2 space-y-2">
                            {[...products,...callsToAction].map((item)=>(
                              ...
                              as="a"
                              href={item.href}
                              className='block rounded-lg pr-3 py-2 pl-6 text-sm font-semibold leading-7 text-white
                              hover:bg-blue-800'
                              >
                                {item.name}
                              </Disclosure.Button>
